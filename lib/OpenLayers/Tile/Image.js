...
OpenLayers.Tile.Image = OpenLayers.Class(OpenLayers.Tile, {
    ...
    draw: function() {
        ...
        if ((OpenLayers.Array.indexOf(this.layer.SUPPORTED_TRANSITIONS, this.layer.transitionEffect) != -1) || 
    ...
    show: function() {
        ...
        if (OpenLayers.Array.indexOf(this.layer.SUPPORTED_TRANSITIONS, 
