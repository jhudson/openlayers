...
OpenLayers.Map = OpenLayers.Class({
     ...
     */
    EVENT_TYPES: [ 
        "preaddlayer", "addlayer", "removelayer", "changelayer", "changebaselayer",
  ...
  // Options
    ...
    initialize: function (div, options) {
        ...
        if (!(this.userProjection instanceof OpenLayers.Projection)) {
            this.userProjection = new OpenLayers.Projection(this.userProjection);
        }
  ...
  /********************************************************/         
    ...
    */    
    ...
    removeLayer: function(layer, setNewBaseLayer) {
        ...
        OpenLayers.Array.removeItem(this.layers, layer);
    ...
    getLayerIndex: function (layer) {
        return OpenLayers.Array.indexOf(this.layers, layer);
    },
    ...
    setBaseLayer: function(newBaseLayer) {
        ...
        if (newBaseLayer != this.baseLayer) {
            ...
            if (OpenLayers.Array.indexOf(this.layers, newBaseLayer) != -1) {
  ...
  /********************************************************/         
    ...
    removeControl: function (control) {
        ...
        if ( (control) && (control == this.getControl(control.id)) ) {
            ...
            OpenLayers.Array.removeItem(this.controls, control);
        }
    },
  ...
  /********************************************************/         
    ...
    */
    removePopup: function(popup) {
        OpenLayers.Array.removeItem(this.popups, popup);
        if (popup.div) {
  ...
  /********************************************************/
   ...
   /** 
     ...
     *
     * Parameters:
     * properties - {Object} Object with *center* and/or *zoom* properites.
     *
     * Returns:
    ...
    set: function(properties) {
        ...
        if (center && !(center instanceof OpenLayers.Location)) {
            center = new OpenLayers.Location(center);
        }
        return this.setCenter(center, properties.zoom);
    },
     ...
     * 
     * Parameters:
     * center - {<OpenLayers.Location> | <OpenLayers.LonLat} The new center location.
    ...
    setCenter: function(center, zoom, dragging, forceZoomChange) {
        if (center && !(center instanceof OpenLayers.LonLat)) {
            center = new OpenLayers.Location(center);
        }
        if (center instanceof OpenLayers.Location) {
            ...
            if (!projection.equals(center.projection)) {
                center = center.transform(projection);
            }
