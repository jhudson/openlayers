...
OpenLayers.Control.SelectFeature = OpenLayers.Class(OpenLayers.Control, {
    ...
    clickFeature: function(feature) {
        if(!this.hover) {
            var selected = (OpenLayers.Array.indexOf(
    ...
    overFeature: function(feature) {
        ...
        if(this.hover) {
            ...
            } else if(OpenLayers.Array.indexOf(
    ...
    unselect: function(feature) {
        ...
        this.unhighlight(feature);
        OpenLayers.Array.removeItem(layer.selectedFeatures, feature);
        ...
        if (position instanceof OpenLayers.Bounds) {
            ...
            for(var l=0; l<layers.length; ++l) {
                ...
                for(var i=0, len = layer.features.length; i<len; ++i) {
                    ...
                    if (this.geometryTypes == null || OpenLayers.Array.indexOf(
                            this.geometryTypes, feature.geometry.CLASS_NAME) > -1) {
                        if (bounds.toGeometry().intersects(feature.geometry)) {
                            if (OpenLayers.Array.indexOf(layer.selectedFeatures, feature) == -1) {
                                this.select(feature);
                            }
                        }
                    }
