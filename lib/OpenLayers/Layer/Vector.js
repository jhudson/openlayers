...
OpenLayers.Layer.Vector = OpenLayers.Class(OpenLayers.Layer, {
    ...
    removeFeatures: function(features, options) {
        ...
        for (var i = features.length - 1; i >= 0; i--) {
            ...
            this.features = OpenLayers.Array.removeItem(this.features, feature);
            ...
            if (OpenLayers.Array.indexOf(this.selectedFeatures, feature) != -1){
                OpenLayers.Array.removeItem(this.selectedFeatures, feature);
            }
